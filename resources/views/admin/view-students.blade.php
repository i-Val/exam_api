                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <span class="font-weight-bolder mr-1"><a class="btn btn-danger" href="/admin/student/delete/{{$pupil->id_number}}">delete</a></span>
                                </div>
                            </td>
                        </tr>
                        @endforeach
...
<form method="POST" action="/admin/students-per-class">
    @csrf
